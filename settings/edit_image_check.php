...
if (!empty($_POST)) {
    ...
    header('Location: edit_image_done.php');
    exit();
};
?>
...
<body>
    <div class="container">
        ...
        <main>
            ...
            <p>イメージ内容を確認して、「登録する」ボタンをクリックしてください。</p>
            <form action="" method="post">
                <input type="hidden" name="action" value="submit" />
                <dl>
                    <dt>イメージ</dt>
                    <dd>
                        <?php if ($_SESSION['edit_image'] !== '') : ?>
                            <img src="image/<?php print(htmlspecialchars($_SESSION['edit_image'], ENT_QUOTES)); ?>" width="150" height="150" alt="" />
                        <?php endif; ?>
                    </dd>
                </dl>
                ...
                <div>
                    <a href="edit_image.php?action=rewrite">&laquo;&nbsp;修正する</a>
                </div>
            </form>
        </main>
    </div>

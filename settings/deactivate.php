...
if (!empty($_POST)) {
    ...
    header('Location: deactivate_done.php');
    exit();
};
?>
...
<body>
    <div class="container">
        ...
        <main>
            <h2>アカウント削除</h2>
            <p>
                現在ログイン中のアカウントを削除します。<br>
                <strong>削除したアカウントを復元させることはできません。</strong><br>
                削除してよろしいですか？
            </p>
            ...
            <form method="post" action="">
                <div class="form-group">
                    ...
                    <button class="btn btn-primary mb-2" type="submit">アカウントを削除</button>
                </div>
            </form>
